		...
		<div id="inner_contents">
			...
			<div>
				<table class="table" id="table">
					...
					<c:forEach var="list" items="${noticeList.content}">
						<tbody>
							<tr>
								<td>${list.id}</td>
								<td class="notice_title"><a href="/notice/${list.id}">${list.title}</a></td>
			...
			<div>
				...
				<ul class="pagination justify-content-center">
					<c:choose>
						<c:when test="${noticeList.first}">
							<li class="page-item disabled"><a class="page-link"
								href="?keyword=${keyword}&page=${noticeList.number-1}">Previous</a></li>
						</c:when>
						<c:otherwise>
					...
					<c:choose>
						<c:when test="${noticeList.last}">
							<li class="page-item disabled"><a class="page-link"
								href="?keyword=${keyword}&page=${noticeList.number+1}">Next</a></li>
						</c:when>
						<c:otherwise>
							<li class="page-item"><a class="page-link"
								href="?keyword=${keyword}&page=${noticeList.number+1}">Next</a></li>
