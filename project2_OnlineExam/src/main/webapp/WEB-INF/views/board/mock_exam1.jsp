	...
	<form action="" method="get">
		...
		<c:forEach var="status" items="${status}">
			<div id="status_${status}" class="exam_wrap">
				<div id="exam_head">
					<h1>
						<i class="fa-solid fa-grip-lines"></i>&nbsp;모의고사 1회&nbsp;<i
											...
											<c:choose>
												<c:when
													...
													<div style="padding-top: 10px;">
														...
														<input type="radio" name="mock1_${exam1.id}" value="1">
														1) <img src="${exam1.num1}">

													</div>
													<div>
														<input type="radio" name="mock1_${exam1.id}" value="2">
														2) <img src="${exam1.num2}">
													</div>
													<div>
														<input type="radio" name="mock1_${exam1.id}" value="3">
														3) <img src="${exam1.num3}">
													</div>
													<div>
														<input type="radio" name="mock1_${exam1.id}" value="4">
								...
								<c:when test="${status == exam2.id}">
									<div class="exam_box">
										...
										<div id="exam_question_box">
											...
											<div style="padding-top: 10px;">
												<input type="radio" name="mock1_${exam2.id}" value="1">
												1) ${exam2.num1 }
											</div>
											<div>
												<input type="radio" name="mock1_${exam2.id}" value="2">
												2) ${exam2.num2 }
											</div>
											<div>
												<input type="radio" name="mock1_${exam2.id}" value="3">
												3) ${exam2.num3 }
											</div>
											<div>
												<input type="radio" name="mock1_${exam2.id}" value="4">
												4) ${exam2.num4 }
											</div>
										</div>
									</div>
...
<script type="text/javascript" src="/js/mock1.js"></script>